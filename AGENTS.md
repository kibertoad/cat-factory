...
- **Orientation**: [`README.md`](./README.md), the CI-guarded [layout](./docs/repository-layout.md),
  [`backend/README.md`](./backend/README.md), and an `AGENTS.md` per package, loaded when you Read
  a file there (Claude Code 2.1.277+). **Never add a `CLAUDE.md` or `CLAUDE.local.md`**: one at or
  above your working directory switches EVERY `AGENTS.md` off and leaves you this file alone.
...
- **Design records**: [`backend/docs/adr/`](./backend/docs/adr/). **In-flight initiatives**:
  `docs/initiatives/`. **Product docs are the WEBSITE** (catfactory.ai), never this tree.
...
- `node scripts/check-no-claude-md.mjs`: no tracked `CLAUDE.md`, which would switch off every `AGENTS.md`.
