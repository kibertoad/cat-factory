...
// Refresh the projections whenever the panel opens while connected.
watch(open, (isOpen) => {
  if (isOpen && github.connected) void github.load()
})
    ...
    <template #body>
      <div class="space-y-5">
        ...
        <template v-if="!github.connected">
          ...
          <USeparator label="or connect an existing installation" />
