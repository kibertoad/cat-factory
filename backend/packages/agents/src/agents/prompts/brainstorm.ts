...
export const REQUIREMENTS_BRAINSTORM_PROMPT: BespokeSystemPrompt = {
  ...
  directives:
    ' ' + NO_ASSUMED_PRODUCT + ' Respond with ONLY a JSON object — no prose, no code fences.',
}

export const REQUIREMENTS_BRAINSTORM_SYSTEM_PROMPT = composeBespokePrompt(
...
export const ARCHITECTURE_BRAINSTORM_SYSTEM_PROMPT = composeBespokePrompt(
...
export const REQUIREMENTS_BRAINSTORM_REWORK_SYSTEM_PROMPT = composeBespokePrompt(
...
export const ARCHITECTURE_BRAINSTORM_REWORK_SYSTEM_PROMPT = composeBespokePrompt(
