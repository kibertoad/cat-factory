...
import { acceptanceCriteriaController } from './modules/acceptance/AcceptanceCriteriaController.js'
...
function registerWorkspaceConfigControllers<E extends AppEnv>(app: Hono<E>): void {
  ...
  app.route('/workspaces/:workspaceId', acceptanceCriteriaController())
