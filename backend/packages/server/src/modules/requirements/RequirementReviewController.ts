...
/**
 * Resolve the requirements module or raise a 503 — it isn't wired on this deployment. Several
...
function requireRequirements<E extends AppEnv>(c: Context<E>): RequirementsModule {
  ...
  if (!requirements) throw new UnavailableError('Requirements review is not configured')
  return requirements
}
