...
// `step-model-local-declarations`); wiring only one is silent — a declaration nothing reads, or a
// dispatch that resolves a local model and can never learn what it accepts.
