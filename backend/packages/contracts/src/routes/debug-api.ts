...
export const listDebugRunsContract = defineApiContract({
  method: 'get',
...
export const getDebugRunContract = defineApiContract({
  method: 'get',
...
export const listDebugLlmCallsContract = defineApiContract({
  method: 'get',
  requestPathParamsSchema: runIdParams,
...
export const getDebugLlmCallContract = defineApiContract({
  method: 'get',
...
export const listDebugAgentContextContract = defineApiContract({
  method: 'get',
  requestPathParamsSchema: runIdParams,
...
export const getDebugAgentContextContract = defineApiContract({
  method: 'get',
...
export const listDebugSearchQueriesContract = defineApiContract({
  method: 'get',
  requestPathParamsSchema: runIdParams,
...
export const listDebugLogsContract = defineApiContract({
  method: 'get',
  requestPathParamsSchema: runIdParams,
