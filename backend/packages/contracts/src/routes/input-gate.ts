...
// ---------------------------------------------------------------------------
// PRE-TOKEN INPUT GATE route contracts. Mounted under `/workspaces/:workspaceId`, so the
...
// @cat-factory/orchestration and `docs/initiatives/pre-token-input-gate.md`.
// ---------------------------------------------------------------------------
