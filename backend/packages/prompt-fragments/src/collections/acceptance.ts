...
// scenarios from requirements, and turning them into Playwright end-to-end
// tests. Selected per block, these bodies are injected verbatim into the
// acceptance / playwright agents' system prompts.
