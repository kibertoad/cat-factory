...
- 7e1f841: Fix `spawn E2BIG` when the Claude Code harness runs with a large composed system prompt.
...
- 77bc73c: Bump the bundled Claude Code CLI to `2.1.201` in the runner image. Codex stays
