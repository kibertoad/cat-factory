...
import { definePublicFragmentConformance } from './integration-public-fragments.js'
...
// debugging, board-provisioning, preset-pinning, best-practice-standard, run-evidence, key-provisioning, outbound-webhook management and hosted MCP surfaces), split into cohesive sibling
...
export function defineIntegrationConformance(harness: ConformanceHarness): void {
  describe(`[${harness.name}] conformance`, () => {
    ...
    definePublicFragmentConformance(harness)
