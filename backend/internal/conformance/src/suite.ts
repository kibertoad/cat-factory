...
export function defineExecutionConformance(harness: ConformanceHarness): void {
  describe(`[${harness.name}] conformance`, () => {
    describe('execution engine', () => {
      ...
      it('resolves a frontend `service` binding to a live env keyed by the service FRAME id', async () => {
        ...
        const envs = await app.call<
          { blockId: string | null; frameId?: string | null; status: string; url: string | null }[]
