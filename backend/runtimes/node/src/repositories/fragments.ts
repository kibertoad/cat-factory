...
export class DrizzlePromptFragmentRepository implements PromptFragmentRepository {
  ...
  async upsert(record: PromptFragmentRecord): Promise<void> {
    const values = {
      ...
      doc_external_id: record.docExternalId,
      doc_via_workspace_id: record.docViaWorkspaceId,
    ...
    await this.db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          doc_external_id: values.doc_external_id,
          doc_via_workspace_id: values.doc_via_workspace_id,
