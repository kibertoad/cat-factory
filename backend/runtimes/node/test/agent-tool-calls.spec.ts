...
// the ORDER assertion: a trajectory ordered by `(started_at, seq)` on one store and by insertion
// on the other reads as two different runs. CI provides Postgres via `DATABASE_URL`.
