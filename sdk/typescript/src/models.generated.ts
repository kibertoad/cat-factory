...
export type PrReportEnvironmentsTeardown = 'confirmed' | 'pending' | 'failed' | 'not_applicable'

/** Every `PrReportEnvironmentsTeardown` value, for exhaustive handling and runtime validation. */
export const PR_REPORT_ENVIRONMENTS_TEARDOWN_VALUES = ['confirmed', 'pending', 'failed', 'not_applicable'] as const
