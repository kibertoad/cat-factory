...
export type DebugRunFailureKind = 'preflight' | 'dispatch' | 'environment' | 'evicted' | 'harness_shutdown' | 'timeout' | 'agent' | 'job_failed' | 'rejected' | 'companion_rejected' | 'stalled' | 'state_unreadable' | 'cancelled' | 'unknown'

/** Every `DebugRunFailureKind` value, for exhaustive handling and runtime validation. */
export const DEBUG_RUN_FAILURE_KIND_VALUES = ['preflight', 'dispatch', 'environment', 'evicted', 'harness_shutdown', 'timeout', 'agent', 'job_failed', 'rejected', 'companion_rejected', 'stalled', 'state_unreadable', 'cancelled', 'unknown'] as const
