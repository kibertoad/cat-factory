...
export type DebugUnavailableToolServerReason = 'harness_unsupported' | 'transport_unsupported' | 'missing_secret' | 'reserved_secret' | 'oauth_not_connected' | 'oauth_token_failed' | 'over_budget'

/** Every `DebugUnavailableToolServerReason` value, for exhaustive handling and runtime validation. */
export const DEBUG_UNAVAILABLE_TOOL_SERVER_REASON_VALUES = ['harness_unsupported', 'transport_unsupported', 'missing_secret', 'reserved_secret', 'oauth_not_connected', 'oauth_token_failed', 'over_budget'] as const
