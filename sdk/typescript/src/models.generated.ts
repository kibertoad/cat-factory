...
export interface PrVerificationReportContext {
  documents: PrVerificationReportContextDocument[]
  note?: string | null
  status: PrReportCiStatus
}

export interface PrVerificationReportContextDocument {
  freshness?: PrVerificationReportContextDocumentFreshness
...
export type PrVerificationReportContextDocumentFreshness =
...
export interface PrVerificationReportContextDocumentFreshnessVariant0 {
  change: PrVerificationReportContextDocumentFreshnessVariant0Change
  status: 'confirmed'
  version: string
}

export type PrVerificationReportContextDocumentFreshnessVariant0Change = 'unchanged' | 'reimported' | 'revision_only'

/** Every `PrVerificationReportContextDocumentFreshnessVariant0Change` value, for exhaustive handling and runtime validation. */
export const PR_VERIFICATION_REPORT_CONTEXT_DOCUMENT_FRESHNESS_VARIANT0_CHANGE_VALUES = ['unchanged', 'reimported', 'revision_only'] as const

export interface PrVerificationReportContextDocumentFreshnessVariant1 {
  status: 'not-applicable'
}

export interface PrVerificationReportContextDocumentFreshnessVariant2 {
  reason: PrVerificationReportContextDocumentFreshnessVariant2Reason
  status: 'unconfirmed'
}

export type PrVerificationReportContextDocumentFreshnessVariant2Reason = 'not_connected' | 'credentials_unreadable' | 'unversioned' | 'source_unreachable'

/** Every `PrVerificationReportContextDocumentFreshnessVariant2Reason` value, for exhaustive handling and runtime validation. */
export const PR_VERIFICATION_REPORT_CONTEXT_DOCUMENT_FRESHNESS_VARIANT2_REASON_VALUES = ['not_connected', 'credentials_unreadable', 'unversioned', 'source_unreachable'] as const

export type PrVerificationReportContextDocumentOrigin = 'confluence' | 'notion' | 'github' | 'figma' | 'zeplin' | 'linear' | 'upload'

/** Every `PrVerificationReportContextDocumentOrigin` value, for exhaustive handling and runtime validation. */
export const PR_VERIFICATION_REPORT_CONTEXT_DOCUMENT_ORIGIN_VALUES = ['confluence', 'notion', 'github', 'figma', 'zeplin', 'linear', 'upload'] as const
