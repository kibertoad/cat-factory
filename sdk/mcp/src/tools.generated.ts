...
// The tool table: one entry per `/api/v1` operation the facade exposes, surface version 1.51.0.
//
...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"description":{"type":"string"},"provisioning":{"description":"Discriminated by `type` (kubernetes). A newer deployment may report a variant not in this list."},"serviceId":{"type":"string"},"status":{"type":"string","description":"One of: planned, ready, in_progress, blocked, pr_ready, done. A newer deployment may report a member not in this list."},"title":{"type":"string"},"type":{"type":"string","description":"One of: frontend, service, library, document, api, database, queue, integration, external, environment. A newer deployment may report a member not in this list."}}},
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"services":{"type":"array","items":{"type":"object","properties":{"description":{"type":"string"},"provisioning":{"description":"Discriminated by `type` (kubernetes). A newer deployment may report a variant not in this list."},"serviceId":{"type":"string"},"status":{"type":"string","description":"One of: planned, ready, in_progress, blocked, pr_ready, done. A newer deployment may report a member not in this list."},"title":{"type":"string"},"type":{"type":"string","description":"One of: frontend, service, library, document, api, database, queue, integration, external, environment. A newer deployment may report a member not in this list."}}}}}},
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"autoStartDependents":{"type":"boolean"},"dependsOn":{"type":"array","items":{"type":"string"}},"description":{"type":"string"},"modelPresetId":{"anyOf":[{"type":"string"},{"type":"null"}]},"progress":{"type":"number"},"pullRequestUrl":{"anyOf":[{"type":"string"},{"type":"null"}]},"riskPolicyId":{"anyOf":[{"type":"string"},{"type":"null"}]},"runId":{"anyOf":[{"type":"string"},{"type":"null"}]},"serviceId":{"type":"string"},"status":{"type":"string","description":"One of: planned, ready, in_progress, blocked, pr_ready, done. A newer deployment may report a member not in this list."},"taskId":{"type":"string"},"taskType":{"type":"string","description":"Usually one of: feature, bug, document, spike, review, ralph, recurring. Other values are accepted where the deployment defines them."},"title":{"type":"string"}}},
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"nextCursor":{"anyOf":[{"type":"string"},{"type":"null"}]},"tasks":{"type":"array","items":{"type":"object","properties":{"autoStartDependents":{"type":"boolean"},"dependsOn":{"type":"array","items":{"type":"string"}},"description":{"type":"string"},"modelPresetId":{"anyOf":[{"type":"string"},{"type":"null"}]},"progress":{"type":"number"},"pullRequestUrl":{"anyOf":[{"type":"string"},{"type":"null"}]},"riskPolicyId":{"anyOf":[{"type":"string"},{"type":"null"}]},"runId":{"anyOf":[{"type":"string"},{"type":"null"}]},"serviceId":{"type":"string"},"status":{"type":"string","description":"One of: planned, ready, in_progress, blocked, pr_ready, done. A newer deployment may report a member not in this list."},"taskId":{"type":"string"},"taskType":{"type":"string","description":"Usually one of: feature, bug, document, spike, review, ralph, recurring. Other values are accepted where the deployment defines them."},"title":{"type":"string"}}}}}},
  ...
  },
  {
    ...
    inputSchema: {"type":"object","properties":{"runId":{"type":"string","description":"Path parameter `runId`."}},"additionalProperties":false,"required":["runId"]},
    outputSchema: {"type":"object","properties":{"diagnostics":{"anyOf":[{"type":"object","properties":{"host":{"type":"object","properties":{"platform":{"type":"string"}}},"lastDispatch":{"type":"object","properties":{"agentKind":{"type":"string"},"at":{"type":"number"},"executionBackend":{"type":"string"},"failure":{"type":"object","properties":{"at":{"type":"number"},"kind":{"type":"string"},"reason":{"type":"string"}}},"model":{"anyOf":[{"type":"string"},{"type":"null"}]},"repo":{"type":"object","properties":{"baseBranch":{"type":"string"},"name":{"type":"string"},"owner":{"type":"string"},"provider":{"type":"string"}}},"stepIndex":{"type":"number"}}}}},{"type":"null"}]},"generatedAt":{"type":"number"},"kind":{"type":"string"},"llm":{"type":"object","properties":{"byAgentKind":{"type":"array","items":{"type":"object","properties":{"agentKind":{"type":"string"},"cacheHitRate":{"anyOf":[{"type":"number"},{"type":"null"}]},"cacheReadTokens":{"type":"number"},"cacheWriteTokens":{"type":"number"},"calls":{"type":"number"},"completionTokens":{"type":"number"},"costEstimate":{"anyOf":[{"type":"number"},{"type":"null"}]},"errors":{"type":"number"},"maxOutputTokens":{"anyOf":[{"type":"number"},{"type":"null"}]},"outputHeadroomRatio":{"anyOf":[{"type":"number"},{"type":"null"}]},"overheadMs":{"type":"number"},"peakCompletionTokens":{"type":"number"},"promptTokens":{"type":"number"},"transportOverheadRatio":{"anyOf":[{"type":"number"},{"type":"null"}]},"truncatedCalls":{"type":"number"},"upstreamMs":{"type":"number"},"warnings":{"type":"number"}}}},"byPhase":{"type":"array","items":{"type":"object","properties":{"cacheHitRate":{"anyOf":[{"type":"number"},{"type":"null"}]},"cacheReadTokens":{"type":"number"},"cacheWriteTokens":{"type":"number"},"calls":{"type":"number"},"carryCostShare":{"anyOf":[{"type":"number"},{"type":"null"}]},"carryCostTokens":{"type":"number"},"completionTokens":{"type":"number"},"costEstimate":{"anyOf":[{"type":"number"},{"type":"null"}]},"errors":{"type":"number"},"overheadMs":{"type":"number"},"phase":{"type":"string"},"promptTokens":{"type":"number"},"truncatedCalls":{"type":"number"},"upstreamMs":{"type":"number"},"warnings":{"type":"number"}}}},"costCurrency":{"anyOf":[{"type":"string"},{"type":"null"}]},"totals":{"type":"object","properties":{"cacheHitRate":{"anyOf":[{"type":"number"},{"type":"null"}]},"cacheReadTokens":{"type":"number"},"cacheWriteTokens":{"type":"number"},"calls":{"type":"number"},"completionTokens":{"type":"number"},"costEstimate":{"anyOf":[{"type":"number"},{"type":"null"}]},"errors":{"type":"number"},"overheadMs":{"type":"number"},"promptTokens":{"type":"number"},"transportOverheadRatio":{"anyOf":[{"type":"number"},{"type":"null"}]},"truncatedCalls":{"type":"number"},"upstreamMs":{"type":"number"},"warnings":{"type":"number"}}}}},"run":{"type":"object","properties":{"blockId":{"type":"string"},"createdAt":{"type":"number"},"currentStep":{"type":"number"},"failure":{"anyOf":[{"type":"object","properties":{"detail":{"anyOf":[{"type":"string"},{"type":"null"}]},"hint":{"anyOf":[{"type":"string"},{"type":"null"}]},"kind":{"type":"string","description":"One of: preflight, dispatch, environment, evicted, timeout, agent, job_failed, rejected, companion_rejected, stalled, state_unreadable, cancelled, unknown. A newer deployment may report a member not in this list."},"lastSubtasks":{"anyOf":[{"type":"object","properties":{"completed":{"type":"number"},"inProgress":{"type":"number"},"items":{"type":"array","items":{"type":"object","properties":{"label":{"type":"string"},"status":{"type":"string","description":"One of: pending, in_progress, completed. A newer deployment may report a member not in this list."}}}},"total":{"type":"number"}}},{"type":"null"}]},"message":{"type":"string"},"occurredAt":{"type":"number"},"reason":{"anyOf":[{"type":"string"},{"type":"null"}]},"stepIndex":{"type":"number"}}},{"type":"null"}]},"pipelineId":{"type":"string"},"pipelineName":{"type":"string"},"runId":{"type":"string"},"status":{"type":"string","description":"One of: running, blocked, paused, done, failed. A newer deployment may report a member not in this list."},"stepCount":{"type":"number"}}},"signals":{"type":"array","items":{"type":"object","properties":{"agentKind":{"anyOf":[{"type":"string"},{"type":"null"}]},"code":{"type":"string"},"count":{"anyOf":[{"type":"number"},{"type":"null"}]},"message":{"type":"string"},"severity":{"type":"string","description":"One of: info, warning, error. A newer deployment may report a member not in this list."},"stepIndex":{"anyOf":[{"type":"number"},{"type":"null"}]}}}},"sinks":{"type":"object","properties":{"agentContext":{"type":"object","properties":{"available":{"type":"boolean"},"count":{"type":"number"}}},"llmCalls":{"type":"object","properties":{"available":{"type":"boolean"},"count":{"type":"number"}}},"provisioningLog":{"type":"object","properties":{"available":{"type":"boolean"},"count":{"type":"number"}}},"searchQueries":{"type":"object","properties":{"available":{"type":"boolean"},"count":{"type":"number"}}},"toolCalls":{"type":"object","properties":{"available":{"type":"boolean"},"count":{"type":"number"}}}}},"steps":{"type":"array","items":{"type":"object","properties":{"agentKind":{"type":"string"},"evictionRecoveries":{"type":"number"},"finishedAt":{"anyOf":[{"type":"number"},{"type":"null"}]},"firstEvictionDetail":{"anyOf":[{"type":"object","properties":{"chars":{"type":"number"},"matchOffset":{"anyOf":[{"type":"number"},{"type":"null"}]},"offset":{"type":"number"},"text":{"type":"string"},"totalChars":{"type":"number"},"truncated":{"type":"boolean"}}},{"type":"null"}]},"hasStructuredResult":{"type":"boolean"},"index":{"type":"number"},"lastActivityAt":{"anyOf":[{"type":"number"},{"type":"null"}]},"model":{"anyOf":[{"type":"string"},{"type":"null"}]},"outputChars":{"type":"number"},"progress":{"type":"number"},"skipped":{"type":"boolean"},"startedAt":{"anyOf":[{"type":"number"},{"type":"null"}]},"state":{"type":"string"},"subtasks":{"anyOf":[{"type":"object","properties":{"completed":{"type":"number"},"inProgress":{"type":"number"},"total":{"type":"number"}}},{"type":"null"}]},"toolServers":{"type":"object","properties":{"agentKind":{"type":"string"},"observed":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"status":{"type":"string","description":"One of: ready, failed, needs_auth, unknown. A newer deployment may report a member not in this list."},"toolCount":{"type":"number"}}}},"unavailable":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"label":{"type":"string"},"reason":{"type":"string","description":"One of: harness_unsupported, transport_unsupported, missing_secret, reserved_secret, unusable_secret, oauth_not_connected, oauth_token_failed, over_budget, consensus_panel. A newer deployment may report a member not in this list."}}}},"wired":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"label":{"type":"string"},"tools":{"type":"array","items":{"type":"string"}},"transport":{"type":"string","description":"One of: stdio, http. A newer deployment may report a member not in this list."}}}}}}}}},"toolCalls":{"type":"object","properties":{"byAgentKind":{"type":"array","items":{"type":"object","properties":{"agentKind":{"type":"string"},"calls":{"type":"number"},"failureRate":{"anyOf":[{"type":"number"},{"type":"null"}]},"failures":{"type":"number"}}}},"byTool":{"type":"array","items":{"type":"object","properties":{"calls":{"type":"number"},"failureRate":{"anyOf":[{"type":"number"},{"type":"null"}]},"failures":{"type":"number"},"tool":{"type":"string"}}}},"totals":{"type":"object","properties":{"calls":{"type":"number"},"failureRate":{"anyOf":[{"type":"number"},{"type":"null"}]},"failures":{"type":"number"}}}}},"version":{"type":"number"}}},
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"nextCursor":{"anyOf":[{"type":"string"},{"type":"null"}]},"runs":{"type":"array","items":{"type":"object","properties":{"blockId":{"type":"string"},"createdAt":{"type":"number"},"currentStep":{"type":"number"},"failure":{"anyOf":[{"type":"object","properties":{"detail":{"anyOf":[{"type":"string"},{"type":"null"}]},"hint":{"anyOf":[{"type":"string"},{"type":"null"}]},"kind":{"type":"string","description":"One of: preflight, dispatch, environment, evicted, timeout, agent, job_failed, rejected, companion_rejected, stalled, state_unreadable, cancelled, unknown. A newer deployment may report a member not in this list."},"lastSubtasks":{"anyOf":[{"type":"object","properties":{"completed":{"type":"number"},"inProgress":{"type":"number"},"items":{"type":"array","items":{"type":"object","properties":{"label":{"type":"string"},"status":{"type":"string","description":"One of: pending, in_progress, completed. A newer deployment may report a member not in this list."}}}},"total":{"type":"number"}}},{"type":"null"}]},"message":{"type":"string"},"occurredAt":{"type":"number"},"reason":{"anyOf":[{"type":"string"},{"type":"null"}]},"stepIndex":{"type":"number"}}},{"type":"null"}]},"pipelineId":{"type":"string"},"pipelineName":{"type":"string"},"runId":{"type":"string"},"status":{"type":"string","description":"One of: running, blocked, paused, done, failed. A newer deployment may report a member not in this list."},"stepCount":{"type":"number"}}}}}},
