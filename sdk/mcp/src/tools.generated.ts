...
// The tool table: one entry per `/api/v1` operation the facade exposes, surface version 1.30.0.
//
...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    inputSchema: {"type":"object","properties":{"taskId":{"type":"string","description":"Path parameter `taskId`."},"body":{"type":"object","properties":{"description":{"type":"string","maxLength":2000},"fields":{"type":"object","additionalProperties":{"anyOf":[{"type":"string"},{"type":"array","items":{"type":"string"}},{"type":"boolean"},{"type":"number"}]}},"title":{"type":"string","minLength":1,"maxLength":200}},"description":"The request body."}},"additionalProperties":false,"required":["taskId","body"]},
    outputSchema: {"type":"object","properties":{"description":{"type":"string"},"progress":{"type":"number"},"pullRequestUrl":{"anyOf":[{"type":"string"},{"type":"null"}]},"runId":{"anyOf":[{"type":"string"},{"type":"null"}]},"serviceId":{"type":"string"},"status":{"type":"string","description":"One of: planned, ready, in_progress, blocked, pr_ready, done. A newer deployment may report a member not in this list."},"taskId":{"type":"string"},"taskType":{"type":"string","description":"Usually one of: feature, bug, document, spike, review, ralph, recurring. Other values are accepted where the deployment defines them."},"title":{"type":"string"}}},
