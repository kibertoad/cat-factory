...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"features":{"type":"array","items":{"type":"object","properties":{"chars":{"type":"number"},"content":{"type":"string"},"group":{"type":"string"},"module":{"type":"string"},"path":{"type":"string"},"totalChars":{"type":"number"},"truncated":{"type":"boolean"}}}},"issues":{"type":"array","items":{"type":"object","properties":{"dropped":{"type":"number"},"kind":{"type":"string","description":"One of: read_failed, unparsed, partial. A newer deployment may report a member not in this list."},"path":{"type":"string"}}}},"present":{"type":"boolean"},"provenance":{"type":"object","properties":{"commit":{"anyOf":[{"type":"string"},{"type":"null"}]},"owner":{"type":"string"},"provider":{"type":"string","description":"One of: github, gitlab. A newer deployment may report a member not in this list."},"ref":{"type":"string"},"repo":{"type":"string"}}},"serviceId":{"type":"string"},"spec":{"anyOf":[{"type":"object","properties":{"modules":{"type":"array","items":{"type":"object","properties":{"groups":{"type":"array","items":{"type":"object","properties":{"name":{"type":"string"},"requirements":{"type":"array","items":{"type":"object","properties":{"acceptance":{"type":"array","items":{"type":"object","properties":{"given":{"type":"string"},"id":{"type":"string"},"outcome":{"type":"string"},"when":{"type":"string"}}}},"id":{"type":"string"},"kind":{"type":"string","description":"One of: functional, nonfunctional, constraint. A newer deployment may report a member not in this list."},"priority":{"type":"string","description":"One of: must, should, could. A newer deployment may report a member not in this list."},"sourceBlockIds":{"type":"array","items":{"type":"string"}},"state":{"type":"string","description":"One of: aspirational, established. A newer deployment may report a member not in this list."},"statement":{"type":"string"},"title":{"type":"string"}}}},"rules":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"rationale":{"type":"string"},"rule":{"type":"string"},"sourceBlockIds":{"type":"array","items":{"type":"string"}}}}},"summary":{"type":"string"}}}},"name":{"type":"string"},"summary":{"type":"string"}}}},"service":{"type":"string"},"summary":{"type":"string"}}},{"type":"null"}]},"truncations":{"type":"array","items":{"type":"object","properties":{"section":{"type":"string","description":"One of: requirements, rules, features. A newer deployment may report a member not in this list."},"shown":{"type":"number"},"total":{"type":"number"}}}}}},
