...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    inputSchema: {"type":"object","properties":{"limit":{"type":"integer"},"cursor":{"type":"string"},"acknowledged":{"type":"string","enum":["true","false"]},"status":{"type":"string","enum":["scheduled","running","complete","failed"]},"agentKind":{"type":"string"},"since":{"type":"integer"}},"additionalProperties":false},
