...
// The tool table: one entry per `/api/v1` operation the facade exposes, surface version 1.50.0.
//
...
export const CAT_FACTORY_TOOL_GROUPS: Readonly<Record<string, string>> = {
  ...
  'services': 'The workspace\'s board services, the frames tasks are created under: list them, create one (optionally backed by a repository), or patch one, including declaring where the manifests for its per-run environments are read from.',
