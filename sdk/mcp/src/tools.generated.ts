...
const QUERY_DEBUG_LIST_TOOL_CALLS = ['limit', 'cursor', 'jobId'] as const
...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    inputSchema: {"type":"object","properties":{"runId":{"type":"string","description":"Path parameter `runId`."},"limit":{"type":"integer"},"cursor":{"type":"string"},"jobId":{"type":"string"}},"additionalProperties":false,"required":["runId"]},
