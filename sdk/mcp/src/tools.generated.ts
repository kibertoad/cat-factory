...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    title: 'List the workspace’s merge-threshold presets',
    group: 'merge_presets',
    operationId: 'listPublicMergePresets',
    readOnly: true,
...
export const CAT_FACTORY_TOOL_GROUPS: Readonly<Record<string, string>> = {
  ...
  'merge_presets': 'The merge-threshold presets a task can resolve, including which is the workspace default: what decides whether a run can land its pull request without a person.',
