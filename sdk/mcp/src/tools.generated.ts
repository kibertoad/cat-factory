...
// The tool table: one entry per `/api/v1` operation the facade exposes, surface version 1.29.0.
//
...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  {
    ...
    outputSchema: {"type":"object","properties":{"createdAt":{"type":"number"},"error":{"anyOf":[{"type":"object","properties":{"code":{"type":"string"},"message":{"type":"string"}}},{"type":"null"}]},"externalIdentity":{"anyOf":[{"type":"string"},{"type":"null"}]},"jobId":{"type":"string"},"pipelineId":{"type":"string"},"result":{"anyOf":[{"type":"object","properties":{"data":{"anyOf":[{},{"type":"null"}]},"output":{"type":"string"}}},{"type":"null"}]},"status":{"type":"string","description":"One of: running, succeeded, failed. A newer deployment may report a member not in this list."}}},
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"jobs":{"type":"array","items":{"type":"object","properties":{"createdAt":{"type":"number"},"error":{"anyOf":[{"type":"object","properties":{"code":{"type":"string"},"message":{"type":"string"}}},{"type":"null"}]},"externalIdentity":{"anyOf":[{"type":"string"},{"type":"null"}]},"jobId":{"type":"string"},"pipelineId":{"type":"string"},"result":{"anyOf":[{"type":"object","properties":{"data":{"anyOf":[{},{"type":"null"}]},"output":{"type":"string"}}},{"type":"null"}]},"status":{"type":"string","description":"One of: running, succeeded, failed. A newer deployment may report a member not in this list."}}}},"nextCursor":{"anyOf":[{"type":"string"},{"type":"null"}]}}},
  ...
  },
  {
    ...
    inputSchema: {"type":"object","properties":{"taskId":{"type":"string","description":"Path parameter `taskId`."}},"additionalProperties":false,"required":["taskId"]},
    outputSchema: {"type":"object","properties":{"createdAt":{"type":"number"},"currentStep":{"type":"number"},"error":{"anyOf":[{"type":"object","properties":{"code":{"type":"string"},"message":{"type":"string"}}},{"type":"null"}]},"externalIdentity":{"anyOf":[{"type":"string"},{"type":"null"}]},"pullRequest":{"anyOf":[{"type":"object","properties":{"branch":{"anyOf":[{"type":"string"},{"type":"null"}]},"url":{"type":"string"}}},{"type":"null"}]},"runId":{"type":"string"},"status":{"type":"string","description":"One of: running, blocked, paused, done, failed. A newer deployment may report a member not in this list."},"steps":{"type":"array","items":{"type":"object","properties":{"agentKind":{"type":"string"},"progress":{"type":"number"},"state":{"type":"string","description":"One of: pending, working, waiting_decision, done. A newer deployment may report a member not in this list."},"subtasks":{"anyOf":[{"type":"object","properties":{"completed":{"type":"number"},"inProgress":{"type":"number"},"total":{"type":"number"}}},{"type":"null"}]}}}},"taskId":{"type":"string"}}},
