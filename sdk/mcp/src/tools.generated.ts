...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    inputSchema: {"type":"object","properties":{"body":{"type":"object","properties":{"name":{"type":"string","minLength":1,"maxLength":100},"owner":{"type":"string","minLength":1,"maxLength":100}},"required":["name","owner"],"description":"The request body."}},"additionalProperties":false,"required":["body"]},
  ...
  },
  {
    ...
    outputSchema: {"type":"object","properties":{"repos":{"type":"array","items":{"type":"object","properties":{"defaultBranch":{"type":"string"},"linked":{"type":"boolean"},"monorepo":{"type":"boolean"},"name":{"type":"string"},"owner":{"type":"string"},"personal":{"type":"boolean"},"private":{"type":"boolean"},"provider":{"type":"string","description":"One of: github, gitlab. A newer deployment may report a member not in this list."},"repoId":{"type":"number"}}}}}},
