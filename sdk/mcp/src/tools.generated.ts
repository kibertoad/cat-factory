...
// The tool table: one entry per `/api/v1` operation the facade exposes, surface version 1.48.0.
//
...
export const CAT_FACTORY_TOOLS: readonly CatFactoryTool[] = [
  ...
  },
  {
    ...
    inputSchema: {"type":"object","properties":{},"additionalProperties":false},
    outputSchema: {"type":"object","properties":{"policies":{"type":"array","items":{"type":"object","properties":{"autoMergeEnabled":{"type":"boolean"},"ciMaxAttempts":{"type":"number"},"dryRunRoles":{"type":"array","items":{"type":"string","description":"One of: admin, member, viewer. A newer deployment may report a member not in this list."}},"isDefault":{"type":"boolean"},"name":{"type":"string"},"policyId":{"type":"string"},"submissionRestrictedRoles":{"type":"array","items":{"type":"string","description":"One of: admin, member, viewer. A newer deployment may report a member not in this list."}}}}}}},
