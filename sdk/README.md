...
behaviour, and a behaviour fix from having to be re-applied across 38 operations × 4 languages.
...
one — a new endpoint cannot ship as an un-callable hole in four SDKs.
...
It is worth being precise about what is and is not possible here. Kotlin's own metadata
...
differently, mapping a refusal to the wrong class, dropping a null, or paginating one page short
— including when nobody had written down what the right answer was.
