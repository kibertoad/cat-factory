...
// The policy-annotated operation table: one entry per `/api/v1` operation, surface version 1.74.0.
//
...
const QUERY_KAIZEN_LIST_ENTRIES: readonly GatekeeperQueryParam[] = [
  { name: 'limit', required: false },
  { name: 'cursor', required: false },
...
export const GATEKEEPER_BINDINGS: readonly GatekeeperBinding[] = [
  ...
  },
  {
    ...
    httpMethod: 'GET',
    path: '/api/v1/repos/{owner}/{name}/contents',
    summary: 'Read one file out of a linked repository',
    minScope: 'admin',
    readOnly: true,
    result: 'value',
    pathParams: ['owner', 'name'],
    queryParams: QUERY_REPOS_GET_FILE,
    hasBody: false,
    invoke: async (client, args) => client.repos.getFile(str(args, 'owner'), str(args, 'name'), pick(args, QUERY_REPOS_GET_FILE)),
  },
  {
    name: 'repos_link',
    group: 'repos',
  ...
  },
  {
    ...
    httpMethod: 'GET',
    path: '/api/v1/use-cases/{useCaseId}',
    summary: 'Get one use case',
    minScope: 'read',
    readOnly: true,
    result: 'value',
    pathParams: ['useCaseId'],
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.useCases.get(str(args, 'useCaseId')),
  },
  {
    ...
    httpMethod: 'POST',
    path: '/api/v1/use-cases/{useCaseId}/invocations',
    ...
    queryParams: [],
    hasBody: true,
    invoke: async (client, args) => client.useCases.invoke(str(args, 'useCaseId'), args.body as Parameters<CatFactoryClient['useCases']['invoke']>[1]),
  },
  {
    name: 'use_cases_list',
    group: 'useCases',
    ...
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.useCases.list(),
  },
  {
  ...
  },
  {
    ...
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.environments.listConnections(),
  },
  {
    name: 'environments_list_manifest_types',
    group: 'environments',
    method: 'listManifestTypes',
    ...
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.environments.listManifestTypes(),
  },
  {
  ...
  },
  {
    ...
    group: 'decisions',
    method: 'addressBugFishingFindings',
    operationId: 'addressPublicRunBugFishingFindings',
    httpMethod: 'POST',
    path: '/api/v1/runs/{runId}/decisions/bug-fishing/address',
    ...
    queryParams: [],
    hasBody: true,
    invoke: async (client, args) => client.decisions.addressBugFishingFindings(str(args, 'runId'), args.body as Parameters<CatFactoryClient['decisions']['addressBugFishingFindings']>[1]),
  },
  {
  ...
  },
  {
    ...
    group: 'decisions',
    method: 'dismissBugFishingFinding',
    operationId: 'dismissPublicRunBugFishingFinding',
    httpMethod: 'POST',
    path: '/api/v1/runs/{runId}/decisions/bug-fishing/findings/{findingId}/dismiss',
    ...
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.decisions.dismissBugFishingFinding(str(args, 'runId'), str(args, 'findingId')),
  },
  {
  ...
  },
  {
    ...
    group: 'decisions',
    method: 'resolveBugFishing',
    operationId: 'resolvePublicRunBugFishing',
    httpMethod: 'POST',
    path: '/api/v1/runs/{runId}/decisions/bug-fishing/resolve',
    ...
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.decisions.resolveBugFishing(str(args, 'runId')),
  },
  {
  ...
  },
  {
    ...
    group: 'decisions',
    method: 'resumePrReview',
    operationId: 'resumePublicRunPrReview',
    httpMethod: 'POST',
    path: '/api/v1/runs/{runId}/decisions/pr-review/resume',
    ...
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.decisions.resumePrReview(str(args, 'runId')),
  },
  {
  ...
  },
  {
    ...
    group: 'kaizen',
    method: 'acknowledgeEntry',
    operationId: 'acknowledgePublicKaizenEntry',
    httpMethod: 'POST',
    path: '/api/v1/kaizen/entries/{entryId}/acknowledge',
    ...
    queryParams: [],
    hasBody: true,
    invoke: async (client, args) => client.kaizen.acknowledgeEntry(str(args, 'entryId'), args.body as Parameters<CatFactoryClient['kaizen']['acknowledgeEntry']>[1]),
  },
  {
    ...
    httpMethod: 'GET',
    path: '/api/v1/kaizen/entries/{entryId}',
    ...
    queryParams: [],
    hasBody: false,
    invoke: async (client, args) => client.kaizen.getEntry(str(args, 'entryId')),
  },
  {
    ...
    result: 'value',
    pathParams: [],
    queryParams: QUERY_KAIZEN_LIST_ENTRIES,
    hasBody: false,
    invoke: async (client, args) => client.kaizen.listEntries(pick(args, QUERY_KAIZEN_LIST_ENTRIES)),
  },
  {
    name: 'keys_create',
    group: 'keys',
