...
// The session type declarations, surface version 1.74.0: one method signature per
...
export const SESSION_METHOD_SIGNATURES: readonly SessionMethodSignature[] = [
  ...
  },
  {
    ...
    doc: '  /**\n   * Mark bug-fishing findings to be addressed\n   *\n   * `POST /api/v1/runs/{runId}/decisions/bug-fishing/address`, scope floor `decide`.\n   */\n',
    signature: '  decisions_address_bug_fishing_findings(args: { runId: string; body: unknown }): Promise<unknown>\n',
  },
  {
  ...
  },
  {
    ...
    doc: '  /**\n   * Dismiss a bug-fishing finding\n   *\n   * `POST /api/v1/runs/{runId}/decisions/bug-fishing/findings/{findingId}/dismiss`, scope floor `decide`.\n   */\n',
    signature: '  decisions_dismiss_bug_fishing_finding(args: { runId: string; findingId: string }): Promise<unknown>\n',
  },
  {
  ...
  },
  {
    ...
    doc: '  /**\n   * Finish a bug-fishing expedition\n   *\n   * `POST /api/v1/runs/{runId}/decisions/bug-fishing/resolve`, scope floor `decide`.\n   */\n',
    signature: '  decisions_resolve_bug_fishing(args: { runId: string }): Promise<unknown>\n',
  },
  {
  ...
  },
  {
    ...
    doc: '  /**\n   * Resume a stalled PR deep review\n   *\n   * `POST /api/v1/runs/{runId}/decisions/pr-review/resume`, scope floor `decide`.\n   */\n',
    signature: '  decisions_resume_pr_review(args: { runId: string }): Promise<unknown>\n',
  },
  {
