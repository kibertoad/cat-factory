...
/**
 * The {@code DebugWiredToolServerTransport} vocabulary.
 ...
 */
public enum DebugWiredToolServerTransport {
    STDIO("stdio"),
    HTTP("http"),
    ...
    DebugWiredToolServerTransport(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugWiredToolServerTransport fromWire(@Nullable String wire) {
        for (DebugWiredToolServerTransport candidate : values()) {
