...
/**
 * The {@code DebugRunSignalSeverity} vocabulary.
 ...
 */
public enum DebugRunSignalSeverity {
    INFO("info"),
    WARNING("warning"),
    ERROR("error"),
    ...
    DebugRunSignalSeverity(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugRunSignalSeverity fromWire(@Nullable String wire) {
        for (DebugRunSignalSeverity candidate : values()) {
