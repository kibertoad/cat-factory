...
/**
 * The {@code PublicResolveExceededChoice} vocabulary.
 ...
 */
public enum PublicResolveExceededChoice {
    ...
    PublicResolveExceededChoice(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicResolveExceededChoice fromWire(@Nullable String wire) {
        for (PublicResolveExceededChoice candidate : values()) {
