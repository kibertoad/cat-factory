...
/**
 * The {@code PrReportEnvironmentsTimelineGap} vocabulary.
 ...
 */
public enum PrReportEnvironmentsTimelineGap {
    UNWIRED("unwired"),
    ...
    PrReportEnvironmentsTimelineGap(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportEnvironmentsTimelineGap fromWire(@Nullable String wire) {
        for (PrReportEnvironmentsTimelineGap candidate : values()) {
