...
/**
 * The {@code PublicJobStatus} vocabulary.
...
public enum PublicJobStatus {
    ...
    @JsonCreator
    public static PublicJobStatus fromWire(@Nullable String wire) {
        for (PublicJobStatus candidate : values()) {
