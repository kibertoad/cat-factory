...
/**
 * The {@code PrReportReproductionVerdict} vocabulary.
 ...
 */
public enum PrReportReproductionVerdict {
    ...
    PrReportReproductionVerdict(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportReproductionVerdict fromWire(@Nullable String wire) {
        for (PrReportReproductionVerdict candidate : values()) {
