...
/**
 * The {@code PublicBugFishingSpawnStatus} vocabulary.
 ...
 */
public enum PublicBugFishingSpawnStatus {
    PENDING("pending"),
    SPAWNED("spawned"),
    FAILED("failed"),
    ...
    PublicBugFishingSpawnStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicBugFishingSpawnStatus fromWire(@Nullable String wire) {
        for (PublicBugFishingSpawnStatus candidate : values()) {
