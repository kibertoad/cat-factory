...
/**
 * The {@code PublicBugFishingFindingKind} vocabulary.
 ...
 */
public enum PublicBugFishingFindingKind {
    BUG("bug"),
    LOGIC_GAP("logic-gap"),
    EDGE_CASE("edge-case"),
    FOOTGUN("footgun"),
    ...
    PublicBugFishingFindingKind(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicBugFishingFindingKind fromWire(@Nullable String wire) {
        for (PublicBugFishingFindingKind candidate : values()) {
