...
/**
 * The {@code PrReportEnvironmentsProof} vocabulary.
 ...
 */
public enum PrReportEnvironmentsProof {
    COMPLETE("complete"),
    ...
    PrReportEnvironmentsProof(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportEnvironmentsProof fromWire(@Nullable String wire) {
        for (PrReportEnvironmentsProof candidate : values()) {
