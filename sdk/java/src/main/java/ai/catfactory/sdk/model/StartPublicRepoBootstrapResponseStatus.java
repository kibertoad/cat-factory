...
/**
 * The {@code StartPublicRepoBootstrapResponseStatus} vocabulary.
...
public enum StartPublicRepoBootstrapResponseStatus {
    ...
    StartPublicRepoBootstrapResponseStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static StartPublicRepoBootstrapResponseStatus fromWire(@Nullable String wire) {
        for (StartPublicRepoBootstrapResponseStatus candidate : values()) {
