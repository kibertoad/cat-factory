...
/**
 * The {@code PublicResolveInputGateChoice} vocabulary.
 ...
 */
public enum PublicResolveInputGateChoice {
    RECHECK("recheck"),
    PROCEED("proceed"),
    ...
    PublicResolveInputGateChoice(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicResolveInputGateChoice fromWire(@Nullable String wire) {
        for (PublicResolveInputGateChoice candidate : values()) {
