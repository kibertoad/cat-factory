...
/**
 * The {@code NotificationSeverity} vocabulary.
...
public enum NotificationSeverity {
    ...
    NotificationSeverity(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static NotificationSeverity fromWire(@Nullable String wire) {
        for (NotificationSeverity candidate : values()) {
