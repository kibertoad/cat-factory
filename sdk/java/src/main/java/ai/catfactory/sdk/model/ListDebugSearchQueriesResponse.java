...
/**
 * The {@code ListDebugSearchQueriesResponse} wire model.
 * @param nextCursor Always present; {@code null} when the server has no value for it.
 * @param queries the {@code queries} field.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public record ListDebugSearchQueriesResponse(
    /** Always present; {@code null} when the server has no value for it. */
    @JsonProperty("nextCursor") @Nullable String nextCursor,

    @JsonProperty("queries") List<DebugSearchQuery> queries
) {

    /** A new builder for {@link ListDebugSearchQueriesResponse}. */
    public static Builder builder() {
        return new Builder();
    }

    /**
     * Fluent builder for {@link ListDebugSearchQueriesResponse}.
    ...
    public static final class Builder {
        ...
        private @Nullable List<DebugSearchQuery> queries;
        ...
        /** Set {@code queries}. */
        public Builder queries(@Nullable List<DebugSearchQuery> queries) {
            this.queries = queries;
            return this;
        }

        /** Build the {@link ListDebugSearchQueriesResponse}. */
        public ListDebugSearchQueriesResponse build() {
            return new ListDebugSearchQueriesResponse(nextCursor, queries);
        }
    }
}
