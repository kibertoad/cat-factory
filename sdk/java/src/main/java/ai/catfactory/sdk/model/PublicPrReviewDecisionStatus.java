...
/**
 * The {@code PublicPrReviewDecisionStatus} vocabulary.
 ...
 */
public enum PublicPrReviewDecisionStatus {
    REVIEWING("reviewing"),
    ...
    PublicPrReviewDecisionStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicPrReviewDecisionStatus fromWire(@Nullable String wire) {
        for (PublicPrReviewDecisionStatus candidate : values()) {
