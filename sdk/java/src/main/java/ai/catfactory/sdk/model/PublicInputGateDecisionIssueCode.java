...
/**
 * The {@code PublicInputGateDecisionIssueCode} vocabulary.
 ...
 */
public enum PublicInputGateDecisionIssueCode {
    ...
    PublicInputGateDecisionIssueCode(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicInputGateDecisionIssueCode fromWire(@Nullable String wire) {
        for (PublicInputGateDecisionIssueCode candidate : values()) {
