...
/**
 * The {@code DocumentFreshnessVariant1} wire model.
 * @param status the {@code status} field.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public record DocumentFreshnessVariant1(
    @JsonProperty("status") String status
) implements DocumentFreshness {

    /** A new builder for {@link DocumentFreshnessVariant1}. */
    public static Builder builder() {
        return new Builder();
    }

    /**
     * Fluent builder for {@link DocumentFreshnessVariant1}.
    ...
    public static final class Builder {
        ...
        /** Build the {@link DocumentFreshnessVariant1}. */
        public DocumentFreshnessVariant1 build() {
            return new DocumentFreshnessVariant1(status);
        }
    }
}
