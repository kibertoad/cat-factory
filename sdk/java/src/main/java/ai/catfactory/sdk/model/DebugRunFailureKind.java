...
/**
 * The {@code DebugRunFailureKind} vocabulary.
 ...
 */
public enum DebugRunFailureKind {
    PREFLIGHT("preflight"),
    DISPATCH("dispatch"),
    ...
    DebugRunFailureKind(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugRunFailureKind fromWire(@Nullable String wire) {
        for (DebugRunFailureKind candidate : values()) {
