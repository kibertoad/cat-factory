...
/**
 * The {@code PrReportCiVerdict} vocabulary.
...
public enum PrReportCiVerdict {
    ...
    @JsonCreator
    public static PrReportCiVerdict fromWire(@Nullable String wire) {
        for (PrReportCiVerdict candidate : values()) {
