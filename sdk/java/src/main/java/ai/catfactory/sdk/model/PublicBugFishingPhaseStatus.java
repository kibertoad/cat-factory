...
/**
 * The {@code PublicBugFishingPhaseStatus} vocabulary.
 ...
 */
public enum PublicBugFishingPhaseStatus {
    PENDING("pending"),
    FISHING("fishing"),
    COMPLETED("completed"),
    FAILED("failed"),
    ...
    PublicBugFishingPhaseStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicBugFishingPhaseStatus fromWire(@Nullable String wire) {
        for (PublicBugFishingPhaseStatus candidate : values()) {
