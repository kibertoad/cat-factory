...
/**
 * The {@code PublicStreamDecisionChannel} vocabulary.
 ...
 */
public enum PublicStreamDecisionChannel {
    TRUE("true"),
    FALSE("false"),
    V1("1"),
    V0("0"),
    ...
    PublicStreamDecisionChannel(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicStreamDecisionChannel fromWire(@Nullable String wire) {
        for (PublicStreamDecisionChannel candidate : values()) {
