...
/**
 * The {@code GetPublicRunOutcomeResponseTestsVariant0Gap} vocabulary.
 ...
 */
public enum GetPublicRunOutcomeResponseTestsVariant0Gap {
    ...
    GetPublicRunOutcomeResponseTestsVariant0Gap(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static GetPublicRunOutcomeResponseTestsVariant0Gap fromWire(@Nullable String wire) {
        for (GetPublicRunOutcomeResponseTestsVariant0Gap candidate : values()) {
