...
/**
 * The {@code NotificationPayloadInitiativeReason} vocabulary.
 ...
 */
public enum NotificationPayloadInitiativeReason {
    ...
    NotificationPayloadInitiativeReason(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static NotificationPayloadInitiativeReason fromWire(@Nullable String wire) {
        for (NotificationPayloadInitiativeReason candidate : values()) {
