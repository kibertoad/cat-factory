...
/**
 * The {@code PublicRunArtifactScope} vocabulary.
 ...
 */
public enum PublicRunArtifactScope {
    RUN("run"),
    TASK("task"),
    ...
    PublicRunArtifactScope(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicRunArtifactScope fromWire(@Nullable String wire) {
        for (PublicRunArtifactScope candidate : values()) {
