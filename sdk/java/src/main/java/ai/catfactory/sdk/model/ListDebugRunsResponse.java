...
/**
 * The {@code ListDebugRunsResponse} wire model.
 * @param nextCursor Always present; {@code null} when the server has no value for it.
 * @param runs the {@code runs} field.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public record ListDebugRunsResponse(
    /** Always present; {@code null} when the server has no value for it. */
    @JsonProperty("nextCursor") @Nullable String nextCursor,

    @JsonProperty("runs") List<DebugRunSummary> runs
) {

    /** A new builder for {@link ListDebugRunsResponse}. */
    public static Builder builder() {
        return new Builder();
    }

    /**
     * Fluent builder for {@link ListDebugRunsResponse}.
    ...
    public static final class Builder {
        ...
        private @Nullable List<DebugRunSummary> runs;
        ...
        /** Set {@code runs}. */
        public Builder runs(@Nullable List<DebugRunSummary> runs) {
            this.runs = runs;
            return this;
        }

        /** Build the {@link ListDebugRunsResponse}. */
        public ListDebugRunsResponse build() {
            return new ListDebugRunsResponse(nextCursor, runs);
        }
    }
}
