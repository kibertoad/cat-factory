...
/**
 * The {@code PublicForkDecisionStatus} vocabulary.
 ...
 */
public enum PublicForkDecisionStatus {
    PROPOSING("proposing"),
    ...
    PublicForkDecisionStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicForkDecisionStatus fromWire(@Nullable String wire) {
        for (PublicForkDecisionStatus candidate : values()) {
