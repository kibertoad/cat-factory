...
/**
 * The {@code PrReportCiStatus} vocabulary.
...
public enum PrReportCiStatus {
    ...
    @JsonCreator
    public static PrReportCiStatus fromWire(@Nullable String wire) {
        for (PrReportCiStatus candidate : values()) {
