...
/**
 * The {@code PublicSpecTruncationSection} vocabulary.
...
public enum PublicSpecTruncationSection {
    ...
    PublicSpecTruncationSection(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicSpecTruncationSection fromWire(@Nullable String wire) {
        for (PublicSpecTruncationSection candidate : values()) {
