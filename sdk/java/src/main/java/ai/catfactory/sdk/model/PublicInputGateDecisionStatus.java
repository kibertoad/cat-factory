...
/**
 * The {@code PublicInputGateDecisionStatus} vocabulary.
 ...
 */
public enum PublicInputGateDecisionStatus {
    OFF("off"),
    ...
    PublicInputGateDecisionStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicInputGateDecisionStatus fromWire(@Nullable String wire) {
        for (PublicInputGateDecisionStatus candidate : values()) {
