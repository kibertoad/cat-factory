...
/**
 * The {@code DebugObservedToolServerStatus} vocabulary.
 ...
 */
public enum DebugObservedToolServerStatus {
    READY("ready"),
    FAILED("failed"),
    ...
    DebugObservedToolServerStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugObservedToolServerStatus fromWire(@Nullable String wire) {
        for (DebugObservedToolServerStatus candidate : values()) {
