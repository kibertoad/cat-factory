...
/**
 * The {@code PublicTaskSourceDocumentSource} vocabulary.
 ...
 */
public enum PublicTaskSourceDocumentSource {
    ...
    PublicTaskSourceDocumentSource(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicTaskSourceDocumentSource fromWire(@Nullable String wire) {
        for (PublicTaskSourceDocumentSource candidate : values()) {
