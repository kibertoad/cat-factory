...
/**
 * The {@code PublicSetFindingStatusStatus} vocabulary.
 ...
 */
public enum PublicSetFindingStatusStatus {
    DISMISSED("dismissed"),
    OPEN("open"),
    ...
    PublicSetFindingStatusStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicSetFindingStatusStatus fromWire(@Nullable String wire) {
        for (PublicSetFindingStatusStatus candidate : values()) {
