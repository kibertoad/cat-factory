...
/**
 * The {@code DebugSearchQueryProvider} vocabulary.
 ...
 */
public enum DebugSearchQueryProvider {
    BRAVE("brave"),
    SEARXNG("searxng"),
    ...
    DebugSearchQueryProvider(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugSearchQueryProvider fromWire(@Nullable String wire) {
        for (DebugSearchQueryProvider candidate : values()) {
