...
/**
 * The {@code DebugInfraLogEntryOutcome} vocabulary.
 ...
 */
public enum DebugInfraLogEntryOutcome {
    SUCCESS("success"),
    FAILURE("failure"),
    ...
    DebugInfraLogEntryOutcome(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugInfraLogEntryOutcome fromWire(@Nullable String wire) {
        for (DebugInfraLogEntryOutcome candidate : values()) {
