...
/**
 * The {@code PublicPromptFragmentTier} vocabulary.
 ...
 */
public enum PublicPromptFragmentTier {
    BUILTIN("builtin"),
    ACCOUNT("account"),
    WORKSPACE("workspace"),
    ...
    PublicPromptFragmentTier(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicPromptFragmentTier fromWire(@Nullable String wire) {
        for (PublicPromptFragmentTier candidate : values()) {
