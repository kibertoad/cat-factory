...
/**
 * The {@code GetPublicRunOutcomeResponseRequirementsVariant0Gap} vocabulary.
 ...
 */
public enum GetPublicRunOutcomeResponseRequirementsVariant0Gap {
    ...
    GetPublicRunOutcomeResponseRequirementsVariant0Gap(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static GetPublicRunOutcomeResponseRequirementsVariant0Gap fromWire(@Nullable String wire) {
        for (GetPublicRunOutcomeResponseRequirementsVariant0Gap candidate : values()) {
