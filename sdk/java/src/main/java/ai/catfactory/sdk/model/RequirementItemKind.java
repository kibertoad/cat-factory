...
/**
 * The {@code RequirementItemKind} vocabulary.
 ...
 */
public enum RequirementItemKind {
    ...
    RequirementItemKind(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static RequirementItemKind fromWire(@Nullable String wire) {
        for (RequirementItemKind candidate : values()) {
