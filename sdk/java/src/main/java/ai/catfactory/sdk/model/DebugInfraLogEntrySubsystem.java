...
/**
 * The {@code DebugInfraLogEntrySubsystem} vocabulary.
 ...
 */
public enum DebugInfraLogEntrySubsystem {
    ...
    DebugInfraLogEntrySubsystem(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugInfraLogEntrySubsystem fromWire(@Nullable String wire) {
        for (DebugInfraLogEntrySubsystem candidate : values()) {
