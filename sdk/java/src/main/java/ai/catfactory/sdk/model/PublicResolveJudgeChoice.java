...
/**
 * The {@code PublicResolveJudgeChoice} vocabulary.
 ...
 */
public enum PublicResolveJudgeChoice {
    PROCEED("proceed"),
    BOUNCE("bounce"),
    STOP("stop"),
    ...
    PublicResolveJudgeChoice(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicResolveJudgeChoice fromWire(@Nullable String wire) {
        for (PublicResolveJudgeChoice candidate : values()) {
