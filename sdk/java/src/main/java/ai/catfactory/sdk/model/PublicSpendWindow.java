...
/**
 * The {@code PublicSpendWindow} vocabulary.
...
public enum PublicSpendWindow {
    ...
    @JsonCreator
    public static PublicSpendWindow fromWire(@Nullable String wire) {
        for (PublicSpendWindow candidate : values()) {
