...
/**
 * The {@code PrReportJudgeDisposition} vocabulary.
 ...
 */
public enum PrReportJudgeDisposition {
    PASS("pass"),
    PARK("park"),
    BOUNCE("bounce"),
    FAIL("fail"),
    ...
    PrReportJudgeDisposition(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportJudgeDisposition fromWire(@Nullable String wire) {
        for (PrReportJudgeDisposition candidate : values()) {
