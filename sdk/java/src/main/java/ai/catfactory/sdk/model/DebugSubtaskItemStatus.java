...
/**
 * The {@code DebugSubtaskItemStatus} vocabulary.
 ...
 */
public enum DebugSubtaskItemStatus {
    PENDING("pending"),
    ...
    DebugSubtaskItemStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugSubtaskItemStatus fromWire(@Nullable String wire) {
        for (DebugSubtaskItemStatus candidate : values()) {
