...
/**
 * The {@code PublicUsageRowBilling} vocabulary.
 ...
 */
public enum PublicUsageRowBilling {
    METERED("metered"),
    ...
    PublicUsageRowBilling(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicUsageRowBilling fromWire(@Nullable String wire) {
        for (PublicUsageRowBilling candidate : values()) {
