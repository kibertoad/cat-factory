...
/**
 * The {@code DebugInfraLogEntryOperation} vocabulary.
...
public enum DebugInfraLogEntryOperation {
    ...
    DebugInfraLogEntryOperation(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DebugInfraLogEntryOperation fromWire(@Nullable String wire) {
        for (DebugInfraLogEntryOperation candidate : values()) {
