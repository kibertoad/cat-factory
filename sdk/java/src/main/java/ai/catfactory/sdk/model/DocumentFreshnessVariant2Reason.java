...
/**
 * The {@code DocumentFreshnessVariant2Reason} vocabulary.
 ...
 */
public enum DocumentFreshnessVariant2Reason {
    ...
    DocumentFreshnessVariant2Reason(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DocumentFreshnessVariant2Reason fromWire(@Nullable String wire) {
        for (DocumentFreshnessVariant2Reason candidate : values()) {
