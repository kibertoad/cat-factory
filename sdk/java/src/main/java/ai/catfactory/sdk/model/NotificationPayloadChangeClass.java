...
/**
 * The {@code NotificationPayloadChangeClass} vocabulary.
 ...
 */
public enum NotificationPayloadChangeClass {
    DOCS("docs"),
    TEST("test"),
    ...
    NotificationPayloadChangeClass(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static NotificationPayloadChangeClass fromWire(@Nullable String wire) {
        for (NotificationPayloadChangeClass candidate : values()) {
