...
/**
 * The {@code PublicBugFishingDecisionStatus} vocabulary.
 ...
 */
public enum PublicBugFishingDecisionStatus {
    FISHING("fishing"),
    ...
    PublicBugFishingDecisionStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicBugFishingDecisionStatus fromWire(@Nullable String wire) {
        for (PublicBugFishingDecisionStatus candidate : values()) {
