...
/**
 * The {@code PublicBrainstormDecisionStage} vocabulary.
 ...
 */
public enum PublicBrainstormDecisionStage {
    ...
    PublicBrainstormDecisionStage(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicBrainstormDecisionStage fromWire(@Nullable String wire) {
        for (PublicBrainstormDecisionStage candidate : values()) {
