...
/**
 * The {@code PrReportContextDocumentOrigin} vocabulary.
 ...
 */
public enum PrReportContextDocumentOrigin {
    ...
    PrReportContextDocumentOrigin(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportContextDocumentOrigin fromWire(@Nullable String wire) {
        for (PrReportContextDocumentOrigin candidate : values()) {
