...
/**
 * The {@code GetPublicMergeRecordResponseDecision} vocabulary.
 ...
 */
public enum GetPublicMergeRecordResponseDecision {
    ...
    GetPublicMergeRecordResponseDecision(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static GetPublicMergeRecordResponseDecision fromWire(@Nullable String wire) {
        for (GetPublicMergeRecordResponseDecision candidate : values()) {
