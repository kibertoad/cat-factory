...
public record ListPublicUseCasesResponseUseCaseParameter(
    ...
    public static final class Builder {
        ...
        public ListPublicUseCasesResponseUseCaseParameter build() {
            return new ListPublicUseCasesResponseUseCaseParameter(defaultValue, defaultValues, help, integer, key, label, max, maxLength, min, options, placeholder, required, section, showWhen, type);
        }
    }
}
