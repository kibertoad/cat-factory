...
/**
 * The {@code ListDebugLlmCallsOrder} vocabulary.
 ...
 */
public enum ListDebugLlmCallsOrder {
    NEWEST("newest"),
    OLDEST("oldest"),
    ...
    ListDebugLlmCallsOrder(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static ListDebugLlmCallsOrder fromWire(@Nullable String wire) {
        for (ListDebugLlmCallsOrder candidate : values()) {
