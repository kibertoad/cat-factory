...
/**
 * The {@code ListDebugToolCallsOrder} vocabulary.
 ...
 */
public enum ListDebugToolCallsOrder {
    RECENT("recent"),
    ...
    ListDebugToolCallsOrder(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static ListDebugToolCallsOrder fromWire(@Nullable String wire) {
        for (ListDebugToolCallsOrder candidate : values()) {
