...
/**
 * The {@code PublicKaizenEntryStatus} vocabulary.
 ...
 */
public enum PublicKaizenEntryStatus {
    SCHEDULED("scheduled"),
    RUNNING("running"),
    COMPLETE("complete"),
    FAILED("failed"),
    ...
    PublicKaizenEntryStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicKaizenEntryStatus fromWire(@Nullable String wire) {
        for (PublicKaizenEntryStatus candidate : values()) {
