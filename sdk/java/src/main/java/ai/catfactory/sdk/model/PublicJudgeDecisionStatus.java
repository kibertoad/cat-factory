...
/**
 * The {@code PublicJudgeDecisionStatus} vocabulary.
 ...
 */
public enum PublicJudgeDecisionStatus {
    ...
    PublicJudgeDecisionStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicJudgeDecisionStatus fromWire(@Nullable String wire) {
        for (PublicJudgeDecisionStatus candidate : values()) {
