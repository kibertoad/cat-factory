...
/**
 * The {@code PublicHumanTestDecisionPhase} vocabulary.
 ...
 */
public enum PublicHumanTestDecisionPhase {
    ...
    PublicHumanTestDecisionPhase(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicHumanTestDecisionPhase fromWire(@Nullable String wire) {
        for (PublicHumanTestDecisionPhase candidate : values()) {
