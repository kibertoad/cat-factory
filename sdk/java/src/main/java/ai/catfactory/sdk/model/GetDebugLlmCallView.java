...
/**
 * The {@code GetDebugLlmCallView} vocabulary.
 ...
 */
public enum GetDebugLlmCallView {
    RAW("raw"),
    MESSAGES("messages"),
    ...
    GetDebugLlmCallView(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static GetDebugLlmCallView fromWire(@Nullable String wire) {
        for (GetDebugLlmCallView candidate : values()) {
