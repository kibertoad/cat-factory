...
/**
 * The {@code PrVerificationReportScopeRole} vocabulary.
 ...
 */
public enum PrVerificationReportScopeRole {
    OWN("own"),
    PEER("peer"),
    ...
    PrVerificationReportScopeRole(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrVerificationReportScopeRole fromWire(@Nullable String wire) {
        for (PrVerificationReportScopeRole candidate : values()) {
