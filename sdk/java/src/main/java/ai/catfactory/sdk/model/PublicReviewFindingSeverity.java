...
/**
 * The {@code PublicReviewFindingSeverity} vocabulary.
 ...
 */
public enum PublicReviewFindingSeverity {
    LOW("low"),
    MEDIUM("medium"),
    HIGH("high"),
    ...
    PublicReviewFindingSeverity(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicReviewFindingSeverity fromWire(@Nullable String wire) {
        for (PublicReviewFindingSeverity candidate : values()) {
