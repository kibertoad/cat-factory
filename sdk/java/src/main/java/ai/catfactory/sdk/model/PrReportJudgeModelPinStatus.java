...
/**
 * The {@code PrReportJudgeModelPinStatus} vocabulary.
 ...
 */
public enum PrReportJudgeModelPinStatus {
    APPLIED("applied"),
    ...
    PrReportJudgeModelPinStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportJudgeModelPinStatus fromWire(@Nullable String wire) {
        for (PrReportJudgeModelPinStatus candidate : values()) {
