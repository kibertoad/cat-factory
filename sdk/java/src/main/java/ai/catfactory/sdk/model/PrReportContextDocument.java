...
/**
 * The {@code PrReportContextDocument} wire model.
...
public record PrReportContextDocument(
    /** May be absent entirely. */
    @JsonInclude(JsonInclude.Include.NON_NULL) @JsonProperty("freshness") @Nullable DocumentFreshness freshness,
    ...
    /** A new builder for {@link PrReportContextDocument}. */
    public static Builder builder() {
        return new Builder();
    }

    /**
     * Fluent builder for {@link PrReportContextDocument}.
    ...
    public static final class Builder {
        ...
        /** Build the {@link PrReportContextDocument}. */
        public PrReportContextDocument build() {
            return new PrReportContextDocument(freshness, movedDuringRun, origin, title, url);
        }
    }
}
