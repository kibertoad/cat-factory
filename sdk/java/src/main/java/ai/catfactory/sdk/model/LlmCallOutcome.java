...
/**
 * The {@code LlmCallOutcome} vocabulary.
...
public enum LlmCallOutcome {
    ...
    @JsonCreator
    public static LlmCallOutcome fromWire(@Nullable String wire) {
        for (LlmCallOutcome candidate : values()) {
