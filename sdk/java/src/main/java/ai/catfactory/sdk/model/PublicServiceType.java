...
/**
 * The {@code PublicServiceType} vocabulary.
...
public enum PublicServiceType {
    ...
    @JsonCreator
    public static PublicServiceType fromWire(@Nullable String wire) {
        for (PublicServiceType candidate : values()) {
