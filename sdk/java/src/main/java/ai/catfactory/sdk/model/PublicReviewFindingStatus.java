...
/**
 * The {@code PublicReviewFindingStatus} vocabulary.
 ...
 */
public enum PublicReviewFindingStatus {
    OPEN("open"),
    ANSWERED("answered"),
    RESOLVED("resolved"),
    DISMISSED("dismissed"),
    ...
    PublicReviewFindingStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicReviewFindingStatus fromWire(@Nullable String wire) {
        for (PublicReviewFindingStatus candidate : values()) {
