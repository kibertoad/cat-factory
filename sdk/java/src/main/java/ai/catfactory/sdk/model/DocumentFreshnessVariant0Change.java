...
/**
 * The {@code DocumentFreshnessVariant0Change} vocabulary.
 ...
 */
public enum DocumentFreshnessVariant0Change {
    UNCHANGED("unchanged"),
    ...
    DocumentFreshnessVariant0Change(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static DocumentFreshnessVariant0Change fromWire(@Nullable String wire) {
        for (DocumentFreshnessVariant0Change candidate : values()) {
