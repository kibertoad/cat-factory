...
/**
 * The {@code PublicRunArtifactKind} vocabulary.
...
public enum PublicRunArtifactKind {
    ...
    PublicRunArtifactKind(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicRunArtifactKind fromWire(@Nullable String wire) {
        for (PublicRunArtifactKind candidate : values()) {
