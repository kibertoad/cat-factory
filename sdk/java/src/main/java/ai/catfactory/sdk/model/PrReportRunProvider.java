...
/**
 * The {@code PrReportRunProvider} vocabulary.
 ...
 */
public enum PrReportRunProvider {
    GITHUB("github"),
    GITLAB("gitlab"),
    ...
    PrReportRunProvider(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportRunProvider fromWire(@Nullable String wire) {
        for (PrReportRunProvider candidate : values()) {
