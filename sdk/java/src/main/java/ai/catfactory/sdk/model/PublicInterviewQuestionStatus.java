...
/**
 * The {@code PublicInterviewQuestionStatus} vocabulary.
 ...
 */
public enum PublicInterviewQuestionStatus {
    OPEN("open"),
    ANSWERED("answered"),
    DISMISSED("dismissed"),
    ...
    PublicInterviewQuestionStatus(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicInterviewQuestionStatus fromWire(@Nullable String wire) {
        for (PublicInterviewQuestionStatus candidate : values()) {
