...
/**
 * The {@code PublicInputGateDecisionMode} vocabulary.
 ...
 */
public enum PublicInputGateDecisionMode {
    STANDARD("standard"),
    ADVISORY("advisory"),
    OFF("off"),
    ...
    PublicInputGateDecisionMode(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicInputGateDecisionMode fromWire(@Nullable String wire) {
        for (PublicInputGateDecisionMode candidate : values()) {
