...
/**
 * The {@code PublicReviewFindingCategory} vocabulary.
 ...
 */
public enum PublicReviewFindingCategory {
    GAP("gap"),
    ...
    PublicReviewFindingCategory(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicReviewFindingCategory fromWire(@Nullable String wire) {
        for (PublicReviewFindingCategory candidate : values()) {
