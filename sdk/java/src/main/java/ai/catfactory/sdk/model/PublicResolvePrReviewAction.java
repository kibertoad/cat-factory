...
/**
 * The {@code PublicResolvePrReviewAction} vocabulary.
 ...
 */
public enum PublicResolvePrReviewAction {
    FINISH("finish"),
    FIX("fix"),
    POST("post"),
    ...
    PublicResolvePrReviewAction(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicResolvePrReviewAction fromWire(@Nullable String wire) {
        for (PublicResolvePrReviewAction candidate : values()) {
