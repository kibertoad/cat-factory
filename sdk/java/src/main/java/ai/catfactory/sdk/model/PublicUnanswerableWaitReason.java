...
/**
 * The {@code PublicUnanswerableWaitReason} vocabulary.
 ...
 */
public enum PublicUnanswerableWaitReason {
    ...
    PublicUnanswerableWaitReason(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PublicUnanswerableWaitReason fromWire(@Nullable String wire) {
        for (PublicUnanswerableWaitReason candidate : values()) {
