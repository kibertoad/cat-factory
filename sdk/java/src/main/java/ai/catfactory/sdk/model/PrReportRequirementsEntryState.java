...
/**
 * The {@code PrReportRequirementsEntryState} vocabulary.
 ...
 */
public enum PrReportRequirementsEntryState {
    ...
    PrReportRequirementsEntryState(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static PrReportRequirementsEntryState fromWire(@Nullable String wire) {
        for (PrReportRequirementsEntryState candidate : values()) {
