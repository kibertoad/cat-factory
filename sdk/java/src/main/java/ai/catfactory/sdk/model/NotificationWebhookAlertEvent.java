...
/**
 * The {@code NotificationWebhookAlertEvent} vocabulary.
 ...
 */
public enum NotificationWebhookAlertEvent {
    ...
    NotificationWebhookAlertEvent(String wire) {
        this.wire = wire;
    }
    ...
    @JsonCreator
    public static NotificationWebhookAlertEvent fromWire(@Nullable String wire) {
        for (NotificationWebhookAlertEvent candidate : values()) {
