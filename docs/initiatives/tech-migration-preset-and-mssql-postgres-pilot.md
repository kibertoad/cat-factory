...
| T8  | `preset_tech_migration` registration: descriptor (form, `phaseTemplate`, `policyDefaults`, review mapping, `planningPipelineId: 'pl_initiative'`) wiring T4, T5, T7                                                                           | MIGRATION | **parent S8**, T1, T2, T3, T7 | ✅ done | #922   |
