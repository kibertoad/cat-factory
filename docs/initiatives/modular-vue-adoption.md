...
**Status:** slice 0 landed (registry in the layer) · **Owner:** frontend · **Started:** 2026-07-18

> This is the durable source of truth for a multi-PR initiative. Read it first before picking up the next slice; update the checklist at the end of each PR. Slice 0 (the registry factory + Nuxt plugin + consumer seam) has landed; slice 1 (navigation) is next.
