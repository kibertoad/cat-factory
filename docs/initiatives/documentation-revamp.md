...
### 15b. `environments-integration.md`: DONE (442 → 341 lines)
...
| Section                                            | Disposition                                                                                                                                                                                                                                                                         |
| -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Built-ins callout                                  | CUT to why `cloudflare` works on a facade with no Docker daemon (it drives the repo's own preview workflow over the Deployments API), pointing at the site's "Choosing a backend" for the choice itself.                                                                            |
...
Every heading survived the cut on purpose: six of them are deep-linked from elsewhere in the same
file, and per the gotcha below nothing would have gone red had one been renamed.
