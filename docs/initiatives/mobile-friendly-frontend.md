...
| A5  | P3  | Mobile head metadata: `theme-color` (match the dark surface) + touch icons. `theme-color` **done**; touch icons need a branded icon asset + a manifest and are folded into E2 (installability). PWA manifest/installability is E2, not this item.                                                                                                                                                                                        | `nuxt.config.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | **partial** (#TBD) — `theme-color` done, icons → E2 |
