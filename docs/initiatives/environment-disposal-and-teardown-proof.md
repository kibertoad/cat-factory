...
| Unit                                                                                                                                                                                                                                                                                                                                                             | Status   |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| **Seeding a `disposer` into the 12 built-in tester/human-test pipelines** (plan decision D-C5). Needs 12 `version` bumps + reseed offers + conformance chain updates, and removes the inspect-the-env-after-merge affordance unless disabled. Recommendation: seed it TERMINALLY (after `merger`) so the default run closes its own proof, as a follow-up slice. | deferred |
