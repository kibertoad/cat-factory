...
A second premise turned out to be wrong, and it is worth stating because it shaped how people
reasoned about this: **our containers are not network-restricted.** The image installs from the
...
dependencies. They were simply never told to, and nothing had prepared the ground.
